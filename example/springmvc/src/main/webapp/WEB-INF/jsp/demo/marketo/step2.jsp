...
<html lang="en">
    <head>
        ...
        <!-- 验证器 -->
        <script type="text/javascript" src="<%=basePath%>va/validation-js/demo_marketo_step2.js"></script>
            ...
            $(function() {
	            ...
	            $("input.toggleCheck").click(function() {
	                if (this.checked == true) {
	                  ...
	                  valid.settings.groups = ["SameCompanyAddress"];
	                  form.attr("action", "<%=basePath%>demo/marketo/do/step2/same");
	                  $("#billingForm").valid();
	                } else {
	                  valid.settings.groups = ["Default"];
	                  form.attr("action", "<%=basePath%>demo/marketo/do/step2/default");
		...
		<div id="page-content-inner" class="resize">
			...
			<div id="col-main" class="resize">
				...
				<div class="main-content resize">
					...
					<br clear="all">
					<div>
						<form id="billingForm" action="<%=basePath%>demo/marketo/do/step2/same" method="post" valid="{error: error}">
							...
							<table cellpadding="0" cellspacing="0" border="0">
										...
										<div style="background-color: #EEEEEE; border: 1px solid #CCCCCC; padding: 10px;" class="subTableDiv">
											<table cellpadding="0" cellspacing="0" border="0">
												<tr>
													...
													<td class="field">
														<input name="bill_first_name" size="20" type="text" tabindex="2" value="">
													</td>
												</tr>
												<tr>
													<td class="label">
													...
													<td class="field">
														<input name="bill_last_name" size="20" type="text" tabindex="3" value="">
													</td>
												</tr>
												<tr>
													<td class="label">
													...
													<td class="field">
														<input name="email" size="20" type="text" tabindex="4" value="">
												...
												<tr>
													...
													<td class="field">
														<input name="bill_address1" size="20" type="text" tabindex="5" value="">
													</td>
												</tr>
												<tr>
													<td class="label"></td>
													<td class="field">
														<input name="bill_address2" size="20" type="text" tabindex="6" value="">
													</td>
												</tr>
												<tr>
													<td class="label">
													...
													<td class="field">
														<input name="bill_city" size="20" type="text" tabindex="7" value="">
													</td>
												</tr>
												<tr>
													<td class="label">
													...
													<td class="field">
														<select id="bill_state" name="bill_state" style="margin-left: 4px;" tabindex="8">
												...
												<tr>
													...
													<td class="field">
														<input name="bill_zip" style="width: 100px" type="text" class="zipcode" tabindex="9" value="">
													</td>
												</tr>
												<tr>
													<td class="label">
													...
													<td class="field">
														<input name="bill_phone" style="width: 100px" type="text" class="phone" tabindex="10" value="">
													</td>
												</tr>
											</table>
										</div>
								...
								<tr>
									...
									<td class="field">
										<select id="cc_type" name="cc_type" class="creditCardType" tabindex="11">
								...
								<tr>
									...
									<td class="field">
										<input id="creditcard" name="credit_card" size="20" type="text" tabindex="14">
									</td>
								</tr>
								<tr>
									<td class="label">
									...
									<td class="field">
										<input id="ccNumber" name="cc_cvv" style="width: 30px;" type="text" style="vertical-align: top;" tabindex="16" value="">
									</td>
								</tr>
								<tr>
									<td></td>

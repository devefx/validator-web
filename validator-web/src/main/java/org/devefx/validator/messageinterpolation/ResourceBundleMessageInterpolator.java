...
public class ResourceBundleMessageInterpolator implements MessageInterpolator {
    ...
    @Override
    public String interpolate(String message, Context context, ResourceBundleLocator validationResourceBundleLocator) {
        ...
        try {
            interpolatedMessage = interpolateMessage(message, context, validationResourceBundleLocator, defaultLocale);
    ...
    @Override
    public String interpolate(String message, Context context, ResourceBundleLocator validationResourceBundleLocator, Locale locale) {
        String interpolatedMessage = message;
        try {
            interpolatedMessage = interpolateMessage(message, context, validationResourceBundleLocator, locale);
     ...
     */
    private String interpolateMessage(String message, Context context, ResourceBundleLocator validationResourceBundleLocator, Locale locale)
            throws MessageDescriptorFormatException {
        String resolvedMessage = interpolateMessage(message, validationResourceBundleLocator, locale);

        // resolve parameter expressions (step 1)
    ...
    private String interpolateMessage(String message, ResourceBundleLocator validationResourceBundleLocator, Locale locale)
        ...
        if (resolvedMessage == null) {
            ResourceBundle validationResourceBundle = validationResourceBundleLocator != null ?
                    validationResourceBundleLocator.getResourceBundle(locale) : null;
            ...
            do {
                // search the validation bundle recursive (step1)
                userBundleResolvedMessage = interpolateBundleMessage(
                        resolvedMessage, validationResourceBundle, locale, true
                );

                // search the user bundle recursive (step2)
                userBundleResolvedMessage = interpolateBundleMessage(
                        userBundleResolvedMessage, userResourceBundle, locale, true
                );
                ...
                // search the default bundle non recursive (step3)
